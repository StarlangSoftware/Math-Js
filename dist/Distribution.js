(function (factory) {
    ...
    class Distribution {
         ...
         */
        static chiSquareInverse(p, freedom) {
            let minchisq = 0.0;
         ...
         * @return the probability of the given input.
         */
        static fDistribution(F, freedom1, freedom2) {
            let a, b, p, d, y;
         ...
         */
        static fDistributionInverse(p, freedom1, freedom2) {
         ...
         * @return the probability of the given input.
         */
        static tDistribution(T, freedom) {
            if (T >= 0) {
         ...
         */
        static tDistributionInverse(p, freedom) {
            if (p < 0.5) {
    ...
    Distribution.Z_MAX = 6.0;
    Distribution.Z_EPSILON = 0.000001;
    Distribution.CHI_EPSILON = 0.000001;
    Distribution.CHI_MAX = 99999.0;
    Distribution.LOG_SQRT_PI = 0.5723649429247000870717135;
    Distribution.I_SQRT_PI = 0.5641895835477562869480795;
    Distribution.BIGX = 200.0;
    Distribution.I_PI = 0.3183098861837906715377675;
    Distribution.F_EPSILON = 0.000001;
    Distribution.F_MAX = 9999.0;
});
